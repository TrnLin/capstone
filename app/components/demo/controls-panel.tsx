...
export function ControlsPanel({
  ...
  const canCompare = overlayMode === "heatmap" || overlayMode === "boxes"
  const focusedLabel =
    activeLabelId !== null ? LABELS_BY_ID[activeLabelId] : null
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        ...
        >
          <ToggleGroupItem value="heatmap" aria-label="Heatmap overlay">
            <LayersIcon data-icon="inline-start" />
            Heatmap
          </ToggleGroupItem>
          <ToggleGroupItem value="boxes" aria-label="Bounding boxes overlay">
            <BoxIcon data-icon="inline-start" />
            Boxes
          </ToggleGroupItem>
          <ToggleGroupItem value="prototypes" aria-label="Prototypes overlay">
      ...
      <div className="space-y-2">
        ...
        {!canCompare && (
          <p className="text-[10px] leading-tight text-muted-foreground">
            Compare works with heatmap or boxes overlays.
          </p>
        )}
      </div>
        ...
        <div className="space-y-1.5 rounded-xl border border-border bg-background/40 p-2.5">
          ...
          <div className="flex items-center gap-2">
            <span
              ...
              style={{ background: focusedLabel.color }}
              aria-hidden
            />
            <Badge
              variant="outline"
              className="truncate"
              title={focusedLabel.name}
            >
              {focusedLabel.shortName}
            </Badge>
            <Button
              variant="ghost"
              size="icon-xs"
